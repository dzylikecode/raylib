...
The C examples are generated by [extract_examples](tools/extract_examples.dart). Run them with:
...
The Dart examples are generated by [example_test](test/example_test.dart), which automatically translates the C examples.
