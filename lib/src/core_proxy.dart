...
void _SetTraceLogCallback(void Function(LogRecord)? handler) {
...
KeyboardKey GetKeyPressed() => KeyboardKey.fromValue(raw.GetKeyPressed());
...
Gesture GetGestureDetected() => Gesture.fromValue(raw.GetGestureDetected());
